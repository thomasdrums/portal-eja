...
function FormularioAula({
  ...
  return (
    <div className="space-y-4">
      ...
      {field("professor",    "Professor Responsável")}
      {field("data",         "Data")}
      {field("youtubeUrl",   "Link do YouTube", "url")}
      {field("formularioUrl","Link do Google Forms de Frequência", "url")}
      ...
      <div className="flex flex-col gap-2 pt-2 sm:flex-row">
        ...
        {!editMode && onSaveFreq && (
          <button
            ...
            className="flex-1 rounded-2xl border-2 border-[#1565c0] py-3 text-sm font-bold text-[#1565c0] transition hover:bg-blue-50 active:scale-[0.98] disabled:opacity-50"
          >
            Salvar Frequência
          </button>
        )}
...
export default function ProfessorAulasPage() {
  ...
  function addAulaComFreq() {
    ...
    setNewForm(emptyForm());
    setShowForm(false);
    showFlash("Aula e frequência cadastradas com sucesso!");
  }
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6">
      ...
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-xl font-bold text-[#0f2d52]">Aulas e Frequência</h1>
        {!showForm && (
          <button
