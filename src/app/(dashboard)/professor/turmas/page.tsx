        ...
        {professorTurmas.map((turma) => {
          ...
          return (
            <Link key={turma.id} href={`/professor/turmas/${turma.id}`} className="group">
              <div className="rounded-3xl bg-white p-5 shadow-md ring-1 ring-gray-100 transition-all hover:shadow-lg active:scale-[0.98]">
                {/* Cabeçalho do card */}
                <div className="mb-4 flex items-center gap-3">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-[#0f2d52] to-[#1565c0] shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-2 text-center">
                  ...
                  <div className="rounded-2xl bg-blue-50 py-2">
                    ...
                    <p className="text-lg font-bold text-blue-700">{cursando}</p>
                  </div>
                </div>
              </div>
            </Link>
