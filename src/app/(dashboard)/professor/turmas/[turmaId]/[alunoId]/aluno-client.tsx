...
// Observações de exemplo — TODO: persistir no banco (próxima etapa; já existe o model Observacao)
...
// ── main component ───────────────────────────────────────
// Recebe o aluno REAL (adaptado) e o id da turma via props (validação/carregamento no servidor).
// Dados pessoais/documentação/situação são reais; Notas/Frequência/Observações continuam como
// placeholders locais até as próximas etapas.
export default function AlunoDetalheClient({
  ...
  const [draft, setDraft]     = useState<Aluno | undefined>(alunoInicial);
  const [flashMsg, setFlashMsg] = useState("");

  // Observações — TODO: persistir no banco (próxima etapa)
